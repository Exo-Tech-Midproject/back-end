...
it('should retrieve all records if no username is provided', async () => {
    const mockRecords = [{ id: 1, username: 'user1' }, { id: 2, username: 'user2' }];
...
it('should retrieve related data for a model (HistoryCreated)', async () => {
  const mockHistoryCreated = [{ id: 1, name: 'history1' }, { id: 2, name: 'history2' }];
...
//   expect(mockUser.getGroups).toHaveBeenCalledWith(model2);
